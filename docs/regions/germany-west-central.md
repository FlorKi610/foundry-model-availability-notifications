...
| gpt-4.1 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard Global Priority Processing |
