...
| gpt-4.1 | Datazone Standard Priority Processing, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard, Standard Global Priority Processing |
| gpt-4.1-mini | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4.1-nano | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| gpt-4o | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4o-mini | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-5 | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| gpt-5-mini | Global Standard, Provisioned (PTU managed), Provisioned global |
| gpt-5-nano | Global Standard |
| gpt-5.1 | Datazone Standard Priority Processing, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard, Standard Global Priority Processing |
| gpt-5.1-chat | Global Standard |
| gpt-5.1-codex | Global Standard, Provisioned global |
| gpt-5.1-codex-mini | Global Standard |
| gpt-5.2 | Datazone Standard Priority Processing, Global Standard, Provisioned (PTU managed), Provisioned global, Standard Global Priority Processing |
| gpt-5.2-codex | Provisioned global |
| gpt-5.3-codex | Provisioned global |
| gpt-5.4 | Datazone Standard Priority Processing, Global Standard, Provisioned global |
| gpt-5.4-mini | Global Standard |
| gpt-5.4-nano | Global Standard |
| gpt-image-1 | Global Standard |
| gpt-image-1-mini | Global Standard |
| gpt-image-1.5 | Global Standard |
...
| o1 | Global Standard, Provisioned global, Standard |
| o3 | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| o3-mini | Global Standard, Global batch, Global batch datazone, Provisioned global |
| o4-mini | Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| text-embedding-3-large | Global Standard, Standard |
| text-embedding-3-small | Global Standard |
