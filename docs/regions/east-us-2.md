...
| FLUX-1.1-pro | Datazone standard, Global Standard |
| FLUX.1-Kontext-pro | Datazone standard, Global Standard |
| FLUX.2-flex | Global Standard |
| FLUX.2-pro | Datazone standard, Global Standard |
...
| Mistral-Large-3 | Datazone standard, Global Standard |
| codex-mini | Global Standard |
| cohere-command-a | Global Standard |
| computer-use-preview | Global Standard |
| embed-v-4-0 | Global Standard |
| gpt-4.1 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4.1-mini | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4.1-nano | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| gpt-4o | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4o-mini | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4o-mini-transcribe | Global Standard |
| gpt-4o-mini-tts | Global Standard |
| gpt-4o-transcribe | Global Standard |
| gpt-4o-transcribe-diarize | Global Standard |
| gpt-5 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| gpt-5-chat | Global Standard |
| gpt-5-codex | Global Standard |
| gpt-5-mini | Datazone provisioned managed, Datazone standard, Global Standard, Provisioned (PTU managed), Provisioned global |
| gpt-5-nano | Datazone standard, Global Standard |
| gpt-5-pro | Global Standard |
| gpt-5.1 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned global, Standard |
| gpt-5.1-chat | Global Standard |
| gpt-5.1-codex | Datazone provisioned managed, Global Standard, Provisioned global |
| gpt-5.1-codex-max | Global Standard |
| gpt-5.1-codex-mini | Global Standard |
| gpt-5.2 | Datazone provisioned managed, Datazone standard, Global Standard, Provisioned global |
| gpt-5.2-chat | Global Standard |
| gpt-5.2-codex | Global Standard, Provisioned global |
| gpt-5.3-chat | Global Standard |
| gpt-5.3-codex | Datazone standard, Global Standard, Provisioned global |
| gpt-5.4 | Datazone provisioned managed, Datazone standard, Global Standard, Provisioned global |
| gpt-5.4-mini | Datazone standard, Global Standard |
| gpt-5.4-nano | Datazone standard, Global Standard |
| gpt-5.4-pro | Global Standard |
| gpt-audio | Global Standard |
| gpt-audio-1.5 | Global Standard |
| gpt-audio-mini | Global Standard |
| gpt-image-1 | Global Standard |
| gpt-image-1-mini | Global Standard |
| gpt-image-1.5 | Datazone standard, Global Standard |
| gpt-realtime | Global Standard |
| gpt-realtime-1.5 | Global Standard |
| gpt-realtime-mini | Global Standard |
| grok-3 | Datazone standard, Global Standard |
| grok-3-mini | Datazone standard, Global Standard |
| grok-4-1-fast-non-reasoning | Datazone standard, Global Standard |
| grok-4-1-fast-reasoning | Datazone standard, Global Standard |
| grok-4-fast-non-reasoning | Datazone standard, Global Standard |
| grok-4-fast-reasoning | Datazone standard, Global Standard |
| mistral-document-ai-2505 | Datazone standard, Global Standard |
| mistral-document-ai-2512 | Datazone standard, Global Standard |
| model-router | Datazone standard, Global Standard |
| o1 | Datazone provisioned managed, Datazone standard, Global Standard, Provisioned global, Standard |
| o3 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| o3-mini | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global |
| o3-pro | Global Standard |
| o4-mini | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard |
| sora-2 | Global Standard |
| text-embedding-3-large | Datazone standard, Global Standard, Standard |
