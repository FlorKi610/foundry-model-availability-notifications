...
| gpt-4.1 | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global, Standard Global Priority Processing |
| gpt-4.1-mini | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4.1-nano | Global Standard, Global batch, Provisioned global |
| gpt-4o | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global, Standard |
| gpt-4o-mini | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global |
| gpt-5 | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global |
...
| gpt-5.1 | Global Standard, Global batch, Provisioned global, Standard Global Priority Processing |
| gpt-5.1-chat | Global Standard |
| gpt-5.1-codex | Global Standard, Provisioned global |
| gpt-5.1-codex-mini | Global Standard |
| gpt-5.2 | Global Standard, Provisioned (PTU managed), Provisioned global, Standard Global Priority Processing |
| gpt-5.2-codex | Provisioned global |
| gpt-5.3-codex | Provisioned global |
| gpt-5.4 | Global Standard, Provisioned (PTU managed), Provisioned global |
...
| o1 | Global Standard, Provisioned (PTU managed), Provisioned global |
| o3 | Global Standard, Global batch, Provisioned global |
| o3-mini | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global |
| o4-mini | Global Standard, Global batch, Provisioned (PTU managed), Provisioned global |
