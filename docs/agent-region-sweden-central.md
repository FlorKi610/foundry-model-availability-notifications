...
| gpt-image-1.5 | ⚠️🔒 Datazone standard | Verfügbar (Docs — bitte im Portal verifizieren) |
...
| model-router | ⚠️🔒 Datazone standard | Verfügbar (Docs — bitte im Portal verifizieren) |
