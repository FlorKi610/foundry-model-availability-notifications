...
| gpt-4.1 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned (PTU managed), Provisioned global, Standard, Standard Global Priority Processing |
...
| gpt-5 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Provisioned global |
...
| gpt-5.1 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Provisioned global, Standard, Standard Global Priority Processing |
...
| gpt-5.2 | Datazone provisioned managed, Global Standard, Provisioned global, Standard Global Priority Processing |
| gpt-5.2-chat | Global Standard |
| gpt-5.2-codex | Global Standard, Provisioned global |
| gpt-5.3-chat | Global Standard |
| gpt-5.3-codex | Global Standard, Provisioned global |
| gpt-5.4 | Datazone provisioned managed, Global Standard, Provisioned global, Standard Global Priority Processing |
...
| o3 | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned global |
| o3-mini | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Provisioned (PTU managed), Provisioned global |
| o3-pro | Global Standard |
| o4-mini | Datazone provisioned managed, Datazone standard, Global Standard, Global batch, Global batch datazone, Provisioned global, Standard |
