...
function createModelAvailabilityService(baseDir) {
  ...
  const regionDiffEuropeSkuFlatPath = path.join(rootDir, 'region_diff_europe_sku_flat.json');
  ...
  const regionDiffWorldwideSkuFlatPath = path.join(rootDir, 'region_diff_worldwide_sku_flat.json');
  ...
  function loadEuropeSkuFlatPayload() {
    return readJson(regionDiffEuropeSkuFlatPath);
  }
  ...
  function loadWorldwideSkuFlatPayload() {
    return readJson(regionDiffWorldwideSkuFlatPath);
  }
