...
In **Switzerland North** sind **57 Modelle** verfügbar.

## Alle Modelle in Switzerland North (Übersicht)
...
## Switzerland North — Modell-Familien und Suchbegriffe
...
## Switzerland North — GPT-5 Modelle
...
## Switzerland North — GPT-4 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard Global Priority Processing, Standard (all) |
...
## Switzerland North — Reasoning Modelle (o-Serie)
...
## Switzerland North — Open-Source & Partner Modelle
...
## Switzerland North — Bild-Generierung
...
## Switzerland North — Audio & Sprache

| Modell | SKU-Varianten |
|--------|---------------|
| whisper | Standard (all) |

## Switzerland North — Embedding Modelle
