# Australia East — Modellverfügbarkeit

Stand: 2026-05-01T07:02:29.692421+00:00

In **Australia East** sind **56 Modelle** verfügbar.

## Alle Modelle in Australia East (Übersicht)
...
## Australia East — Modell-Familien und Suchbegriffe
...
## Australia East — GPT-5 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-5 | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
...
| gpt-5-mini | Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
...
| gpt-5.1 | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
...
| gpt-5.2 | Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
...
| gpt-5.4 | Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
...
## Australia East — GPT-4 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
| gpt-4.1-mini | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard (all) |
| gpt-4.1-nano | Global batch, Provisioned global, Standard global deployments, Standard Global By Capability |
| gpt-4o | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard (all) |
| gpt-4o-mini | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |

## Australia East — Reasoning Modelle (o-Serie)

| Modell | SKU-Varianten |
|--------|---------------|
| o1 | Provisioned global, Standard global deployments, Standard Global By Capability |
| o3 | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
| o3-mini | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
| o4-mini | Global batch, Provisioned global, Standard global deployments, Standard Global By Capability |

## Australia East — Open-Source & Partner Modelle
...
## Australia East — Bild-Generierung
...
## Australia East — Embedding Modelle
