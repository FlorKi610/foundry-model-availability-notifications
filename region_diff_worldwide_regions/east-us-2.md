...
| gpt-5-mini | Datazone US provisioned managed, Datazone US standard, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
...
| gpt-5.1 | Datazone US provisioned managed, Datazone US standard, Global batch, Global batch Datazone US, Provisioned global, Standard global deployments, Standard Global By Capability, Standard (all) |
...
| gpt-5.2 | Datazone US provisioned managed, Datazone US standard, Provisioned global, Standard global deployments, Standard Global By Capability |
...
| gpt-5.4 | Datazone US provisioned managed, Datazone US standard, Provisioned global, Standard global deployments, Standard Global By Capability |
| gpt-5.4-mini | Datazone US standard, Standard global deployments, Standard Global By Capability |
...
| gpt-5.5 | Datazone US standard, Standard global deployments, Standard Global By Capability |

## East US 2 — GPT-4 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Datazone US provisioned managed, Datazone US standard, Global batch, Global batch Datazone US, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard (all) |
...
| gpt-4o-mini-tts | Standard global deployments, Standard Global By Capability |
...
| model-router | Data Zone Standard, Datazone US standard, Global Standard, Standard global deployments, Standard Global By Capability |
