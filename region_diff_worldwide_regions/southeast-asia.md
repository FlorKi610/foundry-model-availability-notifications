...
- **Embedding Modelle** (Suche: embedding, text embedding, ada embedding, embed): text-embedding-3-large

## Southeast Asia — GPT-5 Modelle
...
## Southeast Asia — Reasoning Modelle (o-Serie)
