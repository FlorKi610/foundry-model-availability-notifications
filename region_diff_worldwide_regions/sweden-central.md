# Sweden Central — Model Availability (2026-04-11T20:30:36.988811+00:00)

Total: 177 model/SKU combinations
...
| gpt-4.1 | Datazone EMEA provisioned managed | ✅ |
| gpt-4.1 | Datazone EMEA standard | ✅ |
| gpt-4.1 | Global batch | ✅ |
| gpt-4.1 | Global batch Datazone EMEA | ✅ |
| gpt-4.1 | Provisioned global | ✅ |
| gpt-4.1 | Provisioned (PTU managed) | ✅ |
| gpt-4.1 | Standard global deployments | ✅ |
| gpt-4.1 | Standard Global Priority Processing | ✅ |
| gpt-4.1 | Standard (all) | ✅ |
| gpt-4.1-mini | Datazone EMEA provisioned managed | ✅ |
| gpt-4.1-mini | Datazone EMEA standard | ✅ |
| gpt-4.1-mini | Global batch | ✅ |
| gpt-4.1-mini | Global batch Datazone EMEA | ✅ |
...
| gpt-4.1-nano | Datazone EMEA provisioned managed | ✅ |
| gpt-4.1-nano | Datazone EMEA standard | ✅ |
| gpt-4.1-nano | Global batch | ✅ |
| gpt-4.1-nano | Global batch Datazone EMEA | ✅ |
| gpt-4.1-nano | Provisioned global | ✅ |
| gpt-4.1-nano | Provisioned (PTU managed) | ✅ |
| gpt-4.1-nano | Standard global deployments | ✅ |
| gpt-4o | Datazone EMEA provisioned managed | ✅ |
| gpt-4o | Datazone EMEA standard | ✅ |
| gpt-4o | Global batch | ✅ |
| gpt-4o | Global batch Datazone EMEA | ✅ |
| gpt-4o | Provisioned global | ✅ |
| gpt-4o | Provisioned (PTU managed) | ✅ |
| gpt-4o | Standard global deployments | ✅ |
| gpt-4o | Standard (all) | ✅ |
| gpt-4o-mini | Datazone EMEA provisioned managed | ✅ |
| gpt-4o-mini | Datazone EMEA standard | ✅ |
| gpt-4o-mini | Global batch | ✅ |
| gpt-4o-mini | Global batch Datazone EMEA | ✅ |
...
| gpt-5 | Datazone EMEA provisioned managed | ✅ |
| gpt-5 | Datazone EMEA standard | ✅ |
| gpt-5 | Global batch | ✅ |
...
| gpt-5.2 | Datazone EMEA provisioned managed | ✅ |
| gpt-5.2 | Provisioned global | ✅ |
| gpt-5.2 | Standard global deployments | ✅ |
| gpt-5.2 | Standard Global Priority Processing | ✅ |
...
| gpt-5.4 | Datazone EMEA provisioned managed | ✅ |
| gpt-5.4 | Provisioned global | ✅ |
| gpt-5.4 | Standard global deployments | ✅ |
| gpt-5.4 | Standard Global Priority Processing | ✅ |
...
| gpt-image-1.5 | Datazone EMEA standard | ✅ |
...
| model-router | Datazone EMEA standard | ✅ |
| model-router | Global Standard | ✅ |
| model-router | Standard global deployments | ✅ |
| o1 | Datazone EMEA provisioned managed | ✅ |
| o1 | Datazone EMEA standard | ✅ |
| o1 | Provisioned global | ✅ |
| o1 | Standard global deployments | ✅ |
| o1 | Standard (all) | ✅ |
| o3 | Datazone EMEA provisioned managed | ✅ |
| o3 | Datazone EMEA standard | ✅ |
| o3 | Global batch | ✅ |
| o3 | Global batch Datazone EMEA | ✅ |
| o3 | Provisioned global | ✅ |
| o3 | Standard global deployments | ✅ |
| o3-mini | Datazone EMEA provisioned managed | ✅ |
| o3-mini | Datazone EMEA standard | ✅ |
...
|-------|-----|--------|
| dall-e-3 |  | ⛔ Removed |
| gpt-4o-audio-preview |  | ⛔ Removed |
| gpt-4o-mini-realtime-preview |  | ⛔ Removed |
| gpt-4o-realtime-preview |  | ⛔ Removed |
