# Spain Central — Modellverfügbarkeit

Stand: 2026-05-02T06:46:51.969640+00:00

In **Spain Central** sind **56 Modelle** verfügbar.

## Alle Modelle in Spain Central (Übersicht)
...
## Spain Central — Modell-Familien und Suchbegriffe
...
## Spain Central — GPT-5 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-5 | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability |
...
| gpt-5.1 | Datazone EMEA provisioned managed, Provisioned global, Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
...
## Spain Central — GPT-4 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
| gpt-4.1-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability |
| gpt-4.1-nano | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability |
| gpt-4o | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
| gpt-4o-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |

## Spain Central — Reasoning Modelle (o-Serie)
...
| o3 | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability |
| o3-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability |
| o4-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global By Capability |

## Spain Central — Open-Source & Partner Modelle
...
## Spain Central — Bild-Generierung
...
## Spain Central — Embedding Modelle
