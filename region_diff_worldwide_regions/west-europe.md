...
In **West Europe** sind **58 Modelle** verfügbar.

## Alle Modelle in West Europe (Übersicht)
...
## West Europe — Modell-Familien und Suchbegriffe
...
| gpt-4.1-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Global batch, Global batch Datazone EMEA, Provisioned global, Standard global deployments, Standard Global By Capability, Standard (all) |
...
## West Europe — Reasoning Modelle (o-Serie)
...
| o3 | Datazone EMEA provisioned managed, Datazone EMEA standard, Global batch, Global batch Datazone EMEA, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |
...
| o4-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Global batch, Global batch Datazone EMEA, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability |

## West Europe — Open-Source & Partner Modelle
...
## West Europe — Audio & Sprache

| Modell | SKU-Varianten |
|--------|---------------|
| whisper | Standard (all) |

## West Europe — Embedding Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| embed-v-4-0 | Global Standard |
| text-embedding-3-large | Datazone EMEA standard, Standard global deployments, Standard Global By Capability |
