---
applyTo: '**/*.{html,css,scss,sass,less,jsx,tsx,vue,svelte,astro}'
description: 'Premium UI/UX Architect - Aktiviere diesen Skill für alle UI/UX Design-Fragen, Audits, und visuelles Design. Schlüsselwörter: UI, UX, Design, Layout, Spacing, Typography, Colors, Accessibility, Responsive, Animation, Motion, Visual Hierarchy'
---

# Premium UI/UX Architect
...
<activation_keywords>
Dieser Skill wird aktiviert bei Fragen zu:
- UI Design, UX Design, User Interface, User Experience
- Layout, Grid, Spacing, Whitespace, Margins, Padding
- Typography, Fonts, Text Hierarchy, Font Sizes
- Colors, Color Palette, Color Scheme, Theming, Dark Mode
- Components, Buttons, Cards, Forms, Navigation
- Accessibility, A11y, WCAG, Screen Reader, Focus States
...
- Audit, Review, Critique, Feedback zu visuellem Design
</activation_keywords>
