...
In **Switzerland West** sind **52 Modelle** verfügbar.

## Alle Modelle in Switzerland West (Übersicht)

Cohere-rerank-v4.0-fast, Cohere-rerank-v4.0-pro, DeepSeek-R1, DeepSeek-R1-0528, DeepSeek-V3-0324, DeepSeek-V3.1, DeepSeek-V3.2, DeepSeek-V3.2-Speciale, FLUX-1.1-pro, FLUX.1-Kontext-pro, FLUX.2-flex, FLUX.2-pro, Kimi-K2.5, Llama-3.3-70B-Instruct, Llama-4-Maverick-17B-128E-Instruct-FP8, Mistral-Large-3, cohere-command-a, embed-v-4-0, gpt-4.1, gpt-4.1-mini, gpt-4.1-nano, gpt-4o, gpt-4o-mini, gpt-5, gpt-5-chat, gpt-5-codex, gpt-5-mini, gpt-5-pro, gpt-5.1, gpt-5.1-chat, gpt-5.1-codex, gpt-5.1-codex-mini, gpt-5.2, gpt-5.2-chat, gpt-5.2-codex, gpt-5.3-chat, gpt-5.3-codex, gpt-5.4, gpt-5.4-mini, gpt-5.4-nano, grok-3, grok-3-mini, grok-4-1-fast-non-reasoning, grok-4-1-fast-reasoning, grok-4-fast-non-reasoning, grok-4-fast-reasoning, mistral-document-ai-2505, mistral-document-ai-2512, o1, o3, o3-mini, o4-mini

## Switzerland West — Modell-Familien und Suchbegriffe
...
- **GPT-5 Basis-Familie** (Suche: gpt 5, gpt5): gpt-5, gpt-5-chat, gpt-5-codex, gpt-5-mini, gpt-5-pro, gpt-5.1, gpt-5.1-chat, gpt-5.1-codex, gpt-5.1-codex-mini, gpt-5.2, gpt-5.2-chat, gpt-5.2-codex, gpt-5.3-chat, gpt-5.3-codex, gpt-5.4, gpt-5.4-mini, gpt-5.4-nano
...
## Switzerland West — GPT-5 Modelle
...
## Switzerland West — GPT-4 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Provisioned global, Standard Global Priority Processing |
...
## Switzerland West — Reasoning Modelle (o-Serie)
...
## Switzerland West — Open-Source & Partner Modelle
...
## Switzerland West — Bild-Generierung
...
## Switzerland West — Embedding Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| embed-v-4-0 | Global Standard |

## Switzerland West — Letzte Änderungen
