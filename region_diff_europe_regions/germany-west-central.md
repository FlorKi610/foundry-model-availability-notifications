...
| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Datazone EMEA provisioned managed, Datazone EMEA standard, Global batch, Global batch Datazone EMEA, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global Priority Processing |
...
## Germany West Central — Letzte Änderungen
