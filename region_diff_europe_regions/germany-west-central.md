...
In **Germany West Central** sind **56 Modelle** verfügbar.

## Alle Modelle in Germany West Central (Übersicht)
...
## Germany West Central — Modell-Familien und Suchbegriffe
...
## Germany West Central — GPT-5 Modelle
...
## Germany West Central — GPT-4 Modelle

| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Datazone EMEA provisioned managed, Datazone EMEA standard, Global batch, Global batch Datazone EMEA, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global By Capability, Standard Global Priority Processing |
...
## Germany West Central — Reasoning Modelle (o-Serie)
...
## Germany West Central — Open-Source & Partner Modelle
...
## Germany West Central — Bild-Generierung
...
## Germany West Central — Embedding Modelle
