...
In **Spain Central** sind **54 Modelle** verfügbar.
...
|--------|---------------|
| gpt-5 | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments |
...
| gpt-5.1 | Datazone EMEA provisioned managed, Provisioned global, Standard global deployments, Standard Global Priority Processing |
...
| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments, Standard Global Priority Processing |
| gpt-4.1-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments |
| gpt-4.1-nano | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments |
| gpt-4o | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Provisioned (PTU managed), Standard global deployments |
| gpt-4o-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Provisioned (PTU managed), Standard global deployments |
...
| o3 | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments |
| o3-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments |
| o4-mini | Datazone EMEA provisioned managed, Datazone EMEA standard, Provisioned global, Standard global deployments |
...
## Spain Central — Letzte Änderungen
