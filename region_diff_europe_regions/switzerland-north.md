...
| Modell | SKU-Varianten |
|--------|---------------|
| gpt-4.1 | Global batch, Provisioned global, Provisioned (PTU managed), Standard global deployments, Standard Global Priority Processing, Standard (all) |
...
## Switzerland North — Letzte Änderungen
