...
## Norway East — Reasoning Modelle (o-Serie)
...
## Norway East — Open-Source & Partner Modelle
...
## Norway East — Audio & Sprache

| Modell | SKU-Varianten |
|--------|---------------|
| whisper | Standard (all) |

## Norway East — Embedding Modelle
